...
# various path
parser.add_argument('--save_root', type=str, default='./result-base', help='models and logs are saved here')
...
def main():
	...
	save_path = os.path.join(args.save_root, 'initial_base{}.pth.tar'.format(args.net_name[6:]))
	torch.save({
		'epoch': 0,
		'net': net.state_dict(),
		'prec@1': 0.0,
	...
	for epoch in range(1, args.epochs+1):
		...
		train(train_loader, net, optimizer, criterion, epoch,loss_list,top1_list,top5_list)
...
def train(train_loader, net, optimizer, criterion, epoch,loss_list,top1_list,top5_list):
